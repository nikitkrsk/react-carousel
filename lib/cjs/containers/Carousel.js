...
var Carousel = function (props) {
    ...
    var _b = (0, react_1.useState)(props.images), displayImage = _b[0], setDisplayImage = _b[1];
    ...
    return (react_1.default.createElement("div", { className: "carousel-container ".concat(props.className), ref: containerRef }, displayImage.map(function (image, index) { return (react_1.default.createElement("img", { key: index, src: image, alt: "image ".concat(index), onClick: function () {
